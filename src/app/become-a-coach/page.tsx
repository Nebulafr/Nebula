...
export default function BecomeACoachPage() {
  ...
  const networkImage = PlaceHolderImages.find(img => img.id === 'coach-network');
        ...
        <section className="bg-primary/5 py-20 sm:py-32">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="font-headline text-4xl">Here&apos;s what other coaches are saying</h2>
            </div>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              {testimonials.map((testimonial, index) => (
                <Card key={index} className="p-8 bg-white shadow-none border-none rounded-xl">
        ...
        <section className="py-20 sm:py-32">
          <div className="container">
            <div className="text-left mb-12">
              <h2 className="font-headline text-4xl">Enjoy these benefits & more...</h2>
            </div>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {benefits.map((benefit, i) => (
                <Card key={i} className={`overflow-hidden rounded-xl border-none ${benefit.color}`}>
                   {benefit.image && (
                      <div className="flex justify-center items-center p-8 h-48">
                         <Image
                          src={benefit.image.imageUrl}
                          alt={benefit.image.description}
                          width={benefit.image.id === 'benefit-schedule' ? 200 : 150}
                          height={150}
        ...
        <section className="container pb-20 sm:pb-32">
          <div className="grid grid-cols-5 bg-yellow-50/50 overflow-hidden rounded-xl h-[200px]">
            ...
            <div className="order-2 md:col-span-3 flex flex-col justify-center p-8 sm:p-16 text-left h-[200px]">
              <h2 className="font-headline text-4xl font-semibold">Expand your network.</h2>
              <h2 className="font-headline text-4xl mt-2 font-normal text-muted-foreground">Join the Nebula Community</h2>
              <Link href="/coach-signup" className="inline-flex items-center text-primary font-semibold mt-6">
