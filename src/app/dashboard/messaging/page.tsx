...
const conversations = [
  ...
  },
  {
    ...
    lastMessage: 'Welcome to the Nebula community!',
    time: '3h ago',
    unread: 0,
    role: 'Bot',
  },
  ...
  2: [
     {
      id: 1,
      sender: 'Sarah Chen',
      text: 'Hi, I saw you enrolled in the Product Management program. Do you have any questions?',
      timestamp: '9:00 AM',
      isMe: false,
    },
    {
      id: 2,
      sender: 'Alex',
      text: "Hi Sarah! Yes, I was wondering if you could recommend any resources for a beginner.",
      timestamp: '9:02 AM',
      isMe: true,
    },
    {
  ...
  3: [
    {
      ...
      text: 'Welcome to the Nebula community! Feel free to ask any questions you have.',
      timestamp: '7:00 AM',
      isMe: false,
    },
  ],
