      ...
      <main className="flex-1">
        <section className="bg-primary/5 py-20 text-center sm:py-24">
          <div className="container">
            ...
            <form onSubmit={handleSearchSubmit} className="mx-auto mt-8 flex max-w-xl items-center">
                            ...
                            <li key={category.title}>
                                <button 
                                    ...
                                    className={cn(
                                        ...
                                        selectedCategory === category.title && "bg-muted text-foreground"
                                    )}
                                >
                                    {category.icon}
            ...
            <div className="md:col-span-3">
                 <div className="h-full rounded-lg border p-12">
                    {!selectedCategory ? (
                        <div className="flex flex-col items-center justify-start text-center text-muted-foreground">
                            ...
                            <h3 className="text-base font-semibold text-foreground">Select a category or search above</h3>
                            <p className="max-w-xs mt-1 text-sm">Choose a topic from the sidebar to view related articles and FAQs.</p>
                        </div>
                        ...
                        <div>
                            ...
                            {filteredFaqs.length === 0 && (
                                <p className="text-muted-foreground text-center mt-8">No FAQs found matching your search.</p>
                            )}
                        </div>
                    ) : (
                        <div className="flex flex-col items-center justify-start text-center text-muted-foreground">
                            <BookOpen className="h-12 w-12 mb-4" />
                            <h3 className="text-base font-semibold text-foreground">Articles for {selectedCategory}</h3>
                            <p className="max-w-xs mt-1 text-sm">Content for this category will be displayed here.</p>
                        </div>
                    )}
                 </div>
                ...
                <div className="bg-muted/50 rounded-2xl p-8 text-center mt-16">
                    ...
                    <p className="mt-2 max-w-xl mx-auto text-muted-foreground">
                        Our team is here to assist you. Reach out for personalized support.
                    </p>
                    <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Button size="lg" variant="outline" className="w-full sm:w-auto bg-transparent border-border">
                            Email Support
                        </Button>
                    </div>
                </div>
        ...
        <div className="flex flex-1 items-center gap-10">
          <Link href="/" className="flex items-center gap-2">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M12 0a12 12 0 1 0 12 12A12 12 0 0 0 12 0zm0 22a10 10 0 1 1 10-10 10 10 0 0 1-10 10zm0-18a8 8 0 1 0 8 8 8 8 0 0 0-8-8zm0 14a6 6 0 1 1 6-6 6 6 0 0
