...
export class MessagingController {
  async getConversations(request: NextRequest): Promise<NextResponse> {
  ...
  async createConversation(request: NextRequest): Promise<NextResponse> {
  ...
  async getMessages(request: NextRequest, conversationId: string): Promise<NextResponse> {
    if (!conversationId) {
