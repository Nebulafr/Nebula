...
export class CoachDashboardController {
  ...
  async getSessions(req: NextRequest): Promise<NextResponse> {
    const user = (req as unknown as AuthenticatedRequest).user;
  ...
  async createSession(req: NextRequest): Promise<NextResponse> {
    const user = (req as unknown as AuthenticatedRequest).user;
  ...
  async getPrograms(req: NextRequest): Promise<NextResponse> {
    const user = (req as unknown as AuthenticatedRequest).user;
    const { searchParams } = new URL(req.url);
  ...
  async getPayouts(req: NextRequest): Promise<NextResponse> {
    const user = (req as unknown as AuthenticatedRequest).user;
    const { searchParams } = new URL(req.url);
  ...
  async getStudents(req: NextRequest): Promise<NextResponse> {
    const user = (req as unknown as AuthenticatedRequest).user;
    const { searchParams } = new URL(req.url);
