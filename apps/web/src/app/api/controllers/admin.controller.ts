...
export class AdminController {
  ...
  async updateProgramStatus(request: NextRequest, programId: string): Promise<NextResponse> {
    if (!programId) {
  ...
  async getReviews(request: NextRequest): Promise<NextResponse> {
    const { searchParams } = new URL(request.url);
  ...
  async getRecentSignups(request: NextRequest): Promise<NextResponse> {
    const { searchParams } = new URL(request.url);
  ...
  async getPlatformActivity(request: NextRequest): Promise<NextResponse> {
    const { searchParams } = new URL(request.url);
  ...
  async updateCohort(request: NextRequest, cohortId: string): Promise<NextResponse> {
    if (!cohortId) {
  ...
  async getCohortsByProgram(request: NextRequest): Promise<NextResponse> {
    const { searchParams } = new URL(request.url);
  ...
  async createCohort(request: NextRequest): Promise<NextResponse> {
    const body = await request.json();
  ...
  async deleteReview(request: NextRequest, id: string): Promise<NextResponse> {
    if (!id) {
