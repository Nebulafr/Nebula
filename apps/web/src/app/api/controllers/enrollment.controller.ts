...
import { EnrollmentStatus } from "@nebula/database";
...
export class EnrollmentController {
  async getStudentEnrollments(request: NextRequest): Promise<NextResponse> {
  ...
  async enrollInProgram(request: NextRequest, slug: string): Promise<NextResponse> {
    const user = (request as unknown as AuthenticatedRequest).user;
