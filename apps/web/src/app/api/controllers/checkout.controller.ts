...
export class CheckoutController {
    async createProgramCheckout(request: NextRequest): Promise<NextResponse> {
        let body;
        try {
    ...
    async createSessionCheckout(request: NextRequest): Promise<NextResponse> {
        let body;
        try {
            body = await request.json();
        } catch {
    ...
    async createEventCheckout(request: NextRequest): Promise<NextResponse> {
        let body;
        try {
            body = await request.json();
        } catch {
