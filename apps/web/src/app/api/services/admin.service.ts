...
export class AdminService {
  async getPrograms(params: AdminProgramQueryData): Promise<{ programs: DashboardProgram[]; pagination: any }> {
  ...
  async updateProgramStatus(programId: string, data: ProgramActionData): Promise<{ program: DashboardProgram }> {
    ...
    return { program: result.updatedProgram as any as DashboardProgram };
  }

  async getUsers(params?: AdminUserQueryData): Promise<{ users: AdminUser[]; pagination: any }> {
    ...
    return {
      users: users as any as AdminUser[],
      pagination: {
        total: totalCount,
        page,
        limit,
  ...
  async getReviews(params?: AdminReviewQueryData): Promise<{ reviews: AdminReview[]; pagination: any }> {
  ...
  async getDashboardStats(): Promise<{ stats: AdminDashboardStats }> {
  ...
  async getRecentSignups(limit: number = 5): Promise<any> {
  ...
  async getPlatformActivity(limit: number = 10): Promise<any> {
    // Get recent coaches
  ...
  async getEvents(params?: AdminEventQueryData): Promise<any> {
  ...
  async getCohortsByProgram(programId: string): Promise<any> {
  ...
  async getTransactions(params: AdminTransactionQueryData): Promise<any> {
  ...
  async createUser(data: AdminCreateUserData): Promise<any> {
  ...
  async updateUser(userId: string, data: AdminUpdateUserData): Promise<any> {
