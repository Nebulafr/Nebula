...
export class CoachService {
  ...
  async getCoaches(params: CoachQueryData): Promise<any> {
  ...
  private async fetchTransformedCoaches(params: CoachQueryData): Promise<any> {
  ...
  async createCoach(userId: string, data: CreateCoachData): Promise<any> {
  ...
  async updateCoach(userId: string, data: CoachUpdateData): Promise<any> {
  ...
  async updateCoachExperiences(userId: string, experiences: any[]): Promise<any> {
  ...
  async getCoachExperiences(userId: string): Promise<any> {
    const coach = await this.findCoachByUserId(userId);
  ...
  async findCoachIdBySlug(slug: string): Promise<any> {
  ...
  async getCoachById(coachId: string, authenticatedUserId?: string): Promise<any> {
    const coach = await prisma.coach.findFirst({
      where: {
        id: coachId,
        isActive: true,
  ...
  async fetchCoachPrograms(coachId: string): Promise<any> {
    try {
  ...
  async fetchCoachReviews(coachId: string): Promise<any> {
    try {
  ...
  async getSuggestedCoaches(userId: string, limit: number = 4): Promise<any> {
  ...
  async updateAvailability(userId: string, availability: Record<string, unknown>): Promise<any> {
    const coach = await prisma.coach.findUnique({
      where: { userId },
      select: { id: true },
    });
