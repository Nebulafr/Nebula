...
export class CheckoutService {
    async createProgramCheckout(userId: string, email: string, data: CheckoutProgramData): Promise<any> {
    ...
    async createSessionCheckout(userId: string, email: string, data: CheckoutSessionData): Promise<any> {
    ...
    async createEventCheckout(userId: string, email: string, data: CheckoutEventData): Promise<any> {
        const { eventId } = data;
