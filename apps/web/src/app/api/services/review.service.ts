import { prisma, ReviewTargetType, Prisma } from "@nebula/database";
import {
  NotFoundException,
  BadRequestException,
...
export class ReviewService {
  async createCoachReview(data: Omit<CreateReviewData, "targetType">): Promise<any> {
  ...
  async createProgramReviewBySlug(data: Omit<CreateReviewBySlugData, "targetType" | "targetId">): Promise<any> {
  ...
  async createProgramReview(data: Omit<CreateReviewData, "targetType">): Promise<any> {
  ...
  async deleteCoachReview(id: string): Promise<any> {
  ...
  async deleteProgramReview(id: string): Promise<any> {
