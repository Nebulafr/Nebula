...
import { StudentSession, EnrollmentWithRelations, ProgramWithRelations, EnrolledProgramMaterial } from "@/types";
...
function UpcomingProgramCard({ program }: { program: EnrollmentWithRelations }) {
  return (
    <Card>
      <CardContent className="p-6">
        <div className="flex flex-col gap-6">
          <div className="flex items-start gap-6">
            <div className="flex-1">
              <h3 className="font-bold text-lg">{program.program.title}</h3>
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-sm text-muted-foreground">
                  with {program.coach?.fullName || "Unknown Coach"}
                </p>
              </div>
            </div>
            <Link href={`/programs/${program.program.slug}`}>
              <Button>
              ...
              <AccordionItem value="objectives" className="border-none">
                ...
                <AccordionContent className="px-4 pb-4">
                  <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                    {program.program.objectives && program.program.objectives.length > 0 ? (
                      program.program.objectives.map((obj: string, i: number) => (
                        <li key={i}>{obj}</li>
                      ))
                    ) : (
              ...
              <AccordionItem value="modules" className="border-none">
                ...
                <AccordionContent className="px-4 pb-4 space-y-4">
                  <Accordion type="multiple" className="w-full space-y-2">
                    {program.program.modules?.map((module: any, i: number) => (
...
function CompletedProgramCard({ program }: { program: EnrollmentWithRelations }) {
  return (
        ...
        <div className="grid md:grid-cols-3 gap-6 items-center">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-2 mt-2 text-sm text-muted-foreground">
              ...
              <span>with {program.coach?.fullName}</span>
            </div>
