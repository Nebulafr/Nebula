...
import { ExperienceLevel, UserRole, ProgramWithRelations } from "@/types";
...
export default function EditProgramPage({
  ...
  const program: ProgramWithRelations | undefined = programData?.program;
  ...
  useEffect(() => {
    if (program) {
      ...
      setFormData({
        ...
        difficultyLevel: program.difficultyLevel as ExperienceLevel || ExperienceLevel.BEGINNER,
