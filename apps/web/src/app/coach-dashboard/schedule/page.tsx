...
import {
  useCancelSession as useCancelCoachSession,
  useRescheduleSession as useRescheduleCoachSession,
  useApproveSession as useApproveCoachSession,
  useRejectSession as useRejectCoachSession,
