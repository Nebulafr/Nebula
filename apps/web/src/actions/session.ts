...
import { CoachSessionsResponse, CoachDashboardStats, CoachAvailabilityResponse, CoachStudentsResponse, CoachAvailability, DayAvailability } from '@/types';
...
export async function getCoachStats(): Promise<{ success: boolean; data?: CoachDashboardStats; message?: string }> {
