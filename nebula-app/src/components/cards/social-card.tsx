...
export function SocialCard({
  ...
  const eventUrl = `/events/social/${event.slug}`;

  return (
    <Link href={eventUrl} className="block">
      <Card className="group flex flex-col overflow-hidden rounded-xl shadow-none transition-shadow hover:shadow-lg cursor-pointer h-full">
